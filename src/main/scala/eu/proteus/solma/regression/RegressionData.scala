package eu.proteus.solma.regression

/**
  * Created by Ariane on 05.06.2017.
  * RegressionData taken from
  * https://github.com/apache/flink/tree/master/flink-libraries/flink-ml/src/test/scala/org/apache/flink/ml/regression
  */
